        ...
        dispatcher.register(Commands.literal("ec")
                .then(Commands.literal("debug")
                        .executes(ctx -> {
                            ...
                            ctx.getSource().sendSuccess(() -> Component.literal("Datapack machines: " + MachineDataRegistry.all().size()), false);
                            ctx.getSource().sendSuccess(() -> Component.literal("Datapack tech trees: " + TechTreeDataRegistry.all().size()), false);
                            return 1;
                        }))
