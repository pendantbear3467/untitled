# ExtremeCraft Gameplay Progression
...
## Mid Game
- Build automation chains and tiered generators.
- Acquire rare alloys and rune/void components.
- Encounter tougher mobs and miniboss pressure: Ancient Sentinel, Energy Parasite, Runic Golem.
- Clear dungeons: Collapsed Energy Reactor, Arcane Tower.

## Late Game
- Assemble quantum components and infinity-tier tools.
- Unlock high power abilities and combo interactions.
- Challenge world bosses in major structures:
  - Ancient Core Guardian (Ancient Research Lab)
  - Void Titan (Void Temple)
  - Overcharged Machine God (Machine Fortress)
