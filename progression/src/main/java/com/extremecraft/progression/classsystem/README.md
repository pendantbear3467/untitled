...
- Generic abilities and spells remain the primary extensible action systems; `ability/ClassAbilityService` stays the narrow class-specific trigger path, then compiles supported class abilities into the shared `AbilityExecutor` effect runtime.
